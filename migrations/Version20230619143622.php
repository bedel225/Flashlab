 ...
 */
final class Version20230619143622 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E9FA49D0B FOREIGN KEY (geo_id) REFERENCES geo (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
